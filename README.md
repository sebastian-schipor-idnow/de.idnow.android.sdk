...
```
dependencies {
    implementation 'de.idnow.android.sdk:idnow-platform:5.20.0' // replace "5.20.0" with the version you want to include
}
```
...
```
dependencies {
    implementation 'de.idnow.android.sdk:idnow-platform-no-fintec-XS2A:5.20.0' // replace "5.20.0" with the version you want to include
}
```
